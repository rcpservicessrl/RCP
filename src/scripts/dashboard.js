    (function() {
      ...
      try {
        ...
        console.error("Error initializing Supabase client in dashboard.html:", e);
      }
      ...
      function renderClientsTable() {
        ...
        filtered.forEach(c => {
          ...
          const portalUrl = window.location.origin + window.location.pathname.replace('dashboard.html', 'portal.html');
