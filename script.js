...
const RCP_LEAD_WEBHOOK_URL = 'https://b04b4cde2647dc.lhr.life/webhook/rcp_lead_capture/trigger/rcp-lead';
...
const translations = {
  es: {
    ...
    'nav-portal': 'Portal',
    'nav-tienda': 'Tienda de Productos',
    'nav-planes': 'Planes de Crecimiento',
    // Hero
    ...
    // Cookie consent
    'cookie-text': '🍪 Usamos cookies analíticas para mejorar tu experiencia y medir el rendimiento del sitio. No compartimos tus datos con terceros.',
    'cookie-more': 'Más información',
    'cookie-accept': 'Aceptar todas',
    'cookie-reject': 'Solo esenciales',
    'cookie-details-title': 'Configuración de Cookies',
    'cookie-cat-essential': 'Esenciales',
    'cookie-cat-essential-desc': 'Necesarias para el funcionamiento del sitio. No se pueden desactivar.',
    'cookie-cat-analytics': 'Analíticas (Google Analytics 4)',
    'cookie-cat-analytics-desc': 'Nos ayudan a entender cómo usas el sitio para mejorarlo. Datos anónimos y agregados.',
    'cookie-cat-marketing': 'Marketing',
    'cookie-cat-marketing-desc': 'Permiten medir la efectividad de campañas publicitarias (Meta Ads, Google Ads).',
  ...
  en: {
    ...
    'nav-portal': 'Portal',
    'nav-tienda': 'Product Store',
    'nav-planes': 'Growth Plans',
    ...
    'nav-carreras': 'Careers',
    // Cookie consent
    'cookie-text': '🍪 We use analytical cookies to improve your experience and measure site performance. We do not share your data with third parties.',
    'cookie-more': 'Learn more',
    'cookie-accept': 'Accept all',
    'cookie-reject': 'Essential only',
    'cookie-details-title': 'Cookie Settings',
    'cookie-cat-essential': 'Essential',
    'cookie-cat-essential-desc': 'Required for the site to function. Cannot be disabled.',
    'cookie-cat-analytics': 'Analytics (Google Analytics 4)',
    'cookie-cat-analytics-desc': 'Help us understand how you use the site to improve it. Anonymous and aggregated data.',
    'cookie-cat-marketing': 'Marketing',
    'cookie-cat-marketing-desc': 'Allow us to measure the effectiveness of advertising campaigns (Meta Ads, Google Ads).',
