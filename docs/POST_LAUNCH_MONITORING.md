...
Propietarios requeridos: ingeniería (sitio/CI), operaciones (catálogo), comercial (leads/precios), privacidad/legal (políticas/consentimiento), marketing (SEO/GA4). Los accesos de DNS, Search Console y alertas aún no están verificados.
