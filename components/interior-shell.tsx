    ...
    <>
      ...
      <footer className="site-footer site-footer--interior">
        <div className="container site-footer__top">
          ...
          <div><small>{locale === "es" ? "Explorar" : "Explore"}</small><Link href={locale === "es" ? "/herramientas" : "/en/tools"}>{locale === "es" ? "Encuentra tu ruta" : "Find your route"}</Link><Link href={locale === "es" ? "/servicios" : "/en/services"}>{locale === "es" ? "Servicios" : "Services"}</Link><Link href={locale === "es" ? "/catalogo" : "/en/catalog"}>{locale === "es" ? "Catálogo" : "Catalog"}</Link><Link href={locale === "es" ? "/software-a-la-medida" : "/en/custom-software"}>{locale === "es" ? "Software a la medida" : "Custom software"}</Link><Link href={locale === "es" ? "/facturacion-electronica" : "/en/electronic-invoicing"}>{locale === "es" ? "Facturación electrónica" : "Electronic invoicing"}</Link><Link href={locale === "es" ? "/sectores" : "/en/sectors"}>{locale === "es" ? "Sectores" : "Sectors"}</Link></div>
