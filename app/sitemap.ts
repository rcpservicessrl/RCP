...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const routes = [
    ...
    ["/soluciones/comercios", 0.75, "monthly"],
    ["/soluciones/empresas-de-servicios", 0.75, "monthly"],
    ["/herramientas", 0.75, "monthly"],
    ...
    ["/en/solutions/retail", 0.55, "monthly"],
    ["/en/solutions/service-businesses", 0.55, "monthly"],
    ["/en/tools", 0.55, "monthly"],
